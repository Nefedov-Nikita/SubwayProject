...
public class ShortestPath {
    private static final Graph.Edge[] GRAPH = {
            ...
            new Graph.Edge("Проспект Просвещения", "Парнас", 3),
            new Graph.Edge("Проспект Просвещения", "Озерки", 3),
            new Graph.Edge("Озерки", "Проспект Просвещения", 3),
            new Graph.Edge("Озерки", "Удельная", 3),
            new Graph.Edge("Удельная", "Озерки", 3),
            new Graph.Edge("Удельная", "Пионерская", 3),
            new Graph.Edge("Пионерская", "Удельная", 3),
            new Graph.Edge("Пионерская", "Черная речка", 3),
            new Graph.Edge("Черная речка", "Пионерская", 3),
            new Graph.Edge("Черная речка", "Петроградская", 3),
            new Graph.Edge("Петроградская", "Черная речка", 3),
            new Graph.Edge("Петроградская", "Горьковская", 3),
            new Graph.Edge("Горьковская", "Петроградская", 3),
            new Graph.Edge("Горьковская", "Невский проспект", 3),
            new Graph.Edge("Невский проспект", "Горьковская", 3),
